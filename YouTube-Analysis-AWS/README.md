...
generate access key and secret access key. The description for the access key is 'de-YouTube-project-rir'.
...
Create a new s3 buckets named 'youtube-de-raw-useast1-dev-riri' and upload the data set into two folders one contains json format and another one contains csv format and following Hive-style patterns.
...
Create an IAM role which named 'youtube-de-glue-s3-rule' and add two permission policies AmazonS3FullAccess and AWSGlueServiceRole.
...
42.	        print(e)
43.	        print('Error getting object {} from bucket {}. Make sure they exist and your bucket is in the same region as this function.'.format(key, bucket))
44.	        raise e
...
**8. After transferring raw_statistics into parquet format** 

Create a crawler to determine the schema of the data, and then creates metadata tables in the db_youtube_cleaned database.
...
![image](https://github.com/RiddhiVora23/Portfolio/assets/114712420/1bea5c65-0809-483c-8ef5-4353f2f3a3cc)
